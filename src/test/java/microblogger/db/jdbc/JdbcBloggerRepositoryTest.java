...
@ContextConfiguration(classes=JdbcRepositoryTestConfig.class)
public class JdbcBloggerRepositoryTest {
    @Autowired
    JdbcBloggerRepository bloggerRepository;
    ...
    @Test
    @Transactional
    public void save_existingBlogger() {
        Blogger blogger = new Blogger(4L, "rst", "letmein", "rst",
                "rst", "rst@xyz.com");
        Blogger saved = bloggerRepository.save(blogger);
        assertBlogger(5, saved);
        Blogger updated = bloggerRepository.findByUsername("rst");
